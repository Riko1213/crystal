    ...
    <footer className="bg-slate-700 text-slate-200 text-sm mt-16">
      <Container>
        <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
          ...
          <FooterList>
            <h3 className="text-base font-bold mb-2">Хэрэглэгчийн төв</h3>
            <Link href="#">Бидэнтэй холбогдох</Link>
            <Link href="#">Хууль</Link>
            <Link href="#">Бушаалт </Link>
            <Link href="#">Бусад</Link>
          </FooterList>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-base font-bold mb-2">Бидний тухай</h3>
            <p className="mb-2">
              ОнлайнОнлайнОнлайнОнлайнОнлайнОнлайнОнлайнОнлайнОнлайн
            </p>
            <p>&copy; {new Date().getFullYear()} Онлайн шоп</p>
          </div>
          <FooterList>
